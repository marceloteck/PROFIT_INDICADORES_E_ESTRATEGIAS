...
// ####################################################################
 ...
 e (ifAVBMediaAlta) e (BOPValor > 0) e (Media12 > Media34) e (Media21 > Media34) e (MACD_Linha > MACD_MediaM) 
 e MediaAlta e (MACD_Histograma > 0)  e (PullBackFinderValor > 0)
 e (CDValor > MediaCD)
  ;

// CONDIÇÕES VENDA
 VENDA := (DIPlus < DIMinus) e (RSIValor < 50)
 e (ifAVBMediaBaixa)e (BOPValor < 0) e (Media12 < Media34) e (Media12 < Media34) e (MACD_Linha < MACD_MediaM) 
 e MediaBaixa e (MACD_Histograma < 0) e (PullBackFinderValor < 0)
 e (CDValor < MediaCD)
  ; 
  
// CONDIÇÕES CONSOLIDAÇÃO
 CONSOLIDACAO := (ADXValor < LimiteADX) e (AmplitudeBB < 0.03) e não MediaAlta e não MediaBaixa; 
