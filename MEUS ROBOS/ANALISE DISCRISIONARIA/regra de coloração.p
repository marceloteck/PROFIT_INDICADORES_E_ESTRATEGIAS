...
VAR
   ...
   ValidatPERM1, ValidatPERM2, ValidatPERM3, ValidatPERM4, ValidatPERM5, ValidatPERM6,
   TCG : Boolean; 

    OTB1, OTB2, OTB3, OTB4, OTB5 : Boolean;
...
BEGIN
  ...
  // ValidatPERM1, ValidatPERM2, ValidatPERM3, ValidatPERM4, ValidatPERM5 : Boolean;
   ...
   //PivoUpDownDivergt : 0 alto e 1: baixo e 2: divergente
    ...
    ValidatPERM2 := (close < Media34p) e (open < Media34p); // e PowerVolumePlus_1m; 
    ValidatPERM3 := DifM34_20 e DifCloseVwap; //DifM20_89    // e DifM12_34[10]
     
    ValidatPERM4 := WeisWaveC_1m e PowerVolumeLow_1m;
    ...
    se not HasPosition e ValidatPERM1 e PivoUpDownDivergt(1) e ValidatPERM2 e ValidatPERM3 então PaintBar(255);
    se not HasPosition e ValidatPERM4 e PivoUpDownDivergt(0) e ValidatPERM5 e ValidatPERM6 então PaintBar(clLime);

    se not HasPosition e ValidatPERM4 e PivoUpDownDivergt(0) e ValidatPERM5 e DifM34_20 e not DifCloseVwap então PaintBar(clblue);
    se not HasPosition e ValidatPERM1 e PivoUpDownDivergt(1) e ValidatPERM2 e DifM34_20 e not DifCloseVwap então PaintBar(clfucsia);
  ...
  OTB3 := (Atr <= 42) e (close > Media34p);
   ...
   se PivoUpDownDivergt(0) e OTB1 e not OTB3 e DifM34_20 ou OTB2 então  PaintBar(255);
  
   se PivoUpDownDivergt(2) então PaintBar(clYellow);
  
  
  
    
  //se PivoUpDownDivergt(1) então PaintBar(clfucsia);
 // se PivoUpDownDivergt(0) então PaintBar(clblue); 
